...
import SavedVocabulary from "@/components/saved-vocabulary"

export const metadata: Metadata = {
  title: "저장된 단어 - 이루가이도",
  description: "저장한 일본어 단어를 확인하고 학습하세요.",
}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
          <div className="text-center max-w-3xl">
            <div className="inline-flex items-center justify-center p-1 mb-4 bg-ocean-100 dark:bg-ocean-900/30 rounded-full">
              <span className="px-3 py-1 text-sm font-medium text-ocean-700 dark:text-ocean-300">저장된 단어</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-display font-bold mb-4">
              <span className="gradient-text">나만의</span> 단어장
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              저장한 단어를 확인하고 효과적으로 학습하세요. 장소별, 카테고리별로 정리된 단어를 복습할 수 있습니다.
            </p>
          </div>
        </div>
      </section>
